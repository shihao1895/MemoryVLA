...
class LiberoMemVLATrainerConfig(MemVLATrainerConfig):
    output_dir: str = field(
        default=f'./user_checkpoints/dexbotic/libero_goal_memvla/all-{datetime.now().strftime("%m%d")}')
    wandb_project: str = field(default='dexbotic_libero_goal_memvla')
...
class LiberoMemVLAInferenceConfig(InferenceConfig):
    ...
    model_name_or_path: str = field(
        default='./checkpoints/libero/libero_goal_memvla')
